...
/*
    Algorithm...
    1. Take two Heaps
        a. MinHeap : Maintain elements of upper half with bigget values. 
        b. MaxHeap : Maintains elements of lower half with smaller values. 
    2. Initilize median as 0.
    3. For every new (x) element in stream
        a. Insert (x) in MaxHeap, if maxheap is empty or 
